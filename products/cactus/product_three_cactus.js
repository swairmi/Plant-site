...
/*******************SECTION FOUR SQUARES MORE OPTION BUTTONS************************/
  ...
  $(".button_more_options_letter").click(function(){
    $("#selector_box_letter_mover").toggleClass("selector_box_letter");
  });
});

	$(document).ready(function(){
  $(".button_more_options_star").click(function(){
    $("#selector_box_star_mover").toggleClass("selector_box_star");
  });
});

	$(document).ready(function(){
  $(".button_more_options_cactus").click(function(){
    $("#selector_box_cactus_mover").toggleClass("selector_box_cactus");
  });
});

	$(document).ready(function(){
  $(".button_more_options_heart").click(function(){
    $("#selector_box_heart_mover").toggleClass("selector_box_heart");
  });
});

	$(document).ready(function(){
  $(".button_more_options_number").click(function(){
    $("#selector_box_number_mover").toggleClass("selector_box_number");
  });
});
